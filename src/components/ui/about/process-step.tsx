              ...
              >
                <CardContent className="flex items-center gap-6 p-6">
                  ...
                  <div className="flex flex-col items-start gap-2 flex-1">
                    <h3 className="font-semibold text-[#101828] text-xl font-figtree tracking-[0] leading-5">
                      {benefit.title}
                    </h3>
      ...
      <Card className="w-full max-w-[1280px] bg-[#194170] rounded overflow-hidden shadow-shadow-sm border-0">
        <CardContent className="flex flex-col items-start justify-center gap-10 p-6">
          <div className="flex items-start gap-6 w-full">
            <h2 className="flex-1 font-figtree font-semibold text-white text-3xl tracking-[0] leading-8">
              Ready to Simplify Your Fleet Finance?
            </h2>

            <p className="flex-1 font-medium text-white text-lg font-figtree tracking-[0] leading-5">
