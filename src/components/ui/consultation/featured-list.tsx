    ...
    <section className="flex flex-col w-full items-center gap-16 px-0 py-16 bg-white">
      <div className="w-full max-w-[1280px] px-6">
        <Card className="bg-gray-50 border-border shadow-shadow-sm">
          <CardContent className="flex flex-col items-start gap-12 p-7">
            <div className="flex flex-col items-start justify-center gap-4 w-full">
              <h2 className="flex items-center justify-center w-full [font-family:'Figtree',Helvetica] font-semibold text-[#101828] text-4xl tracking-[-0.40px] leading-[45px]">
                What the Free Consultation Offers
              </h2>

              <p className="w-full [font-family:'Figtree',Helvetica] font-normal text-[#4a5565] text-lg tracking-[0] leading-7">
            ...
            <div className="flex flex-col items-start gap-[18px] w-full">
              <h3 className="flex items-center justify-center w-full [font-family:'Figtree',Helvetica] font-semibold text-[#101828] text-2xl tracking-[-0.40px] leading-[30px]">
                ...
                {consultationFeatures.map((feature, index) => (
                  ...
                  >
                    <CardContent className="flex flex-col items-start justify-center gap-6 p-6">
                      <div className="flex w-16 h-16 items-center justify-center bg-[#fafcfe] rounded">
                        <img
                          className="w-9 h-9"
                          alt="Check"
                          src={feature.icon}
                      ...
                      <div className="flex flex-col items-start gap-2 w-full">
                        <h4 className="w-full [font-family:'Figtree',Helvetica] font-semibold text-[#101828] text-xl tracking-[0] leading-5">
                          {feature.title}
                        </h4>

                        <p className="w-full font-normal text-[#4a5565] text-base [font-family:'Figtree',Helvetica] tracking-[0] leading-6">
                          {feature.description}
                        </p>
                      </div>
                    </CardContent>
        ...
        <Card className="bg-[#194170] border-none shadow-shadow-sm">
          <CardContent className="flex flex-col items-start justify-center gap-10 p-6">
            <div className="grid grid-cols-2 gap-6 w-full">
              <h2 className="flex items-center justify-center [font-family:'Figtree',Helvetica] font-semibold text-white text-3xl tracking-[0] leading-8">
                Ready to Get Started?
              </h2>

              <p className="flex items-center justify-center [font-family:'Figtree',Helvetica] font-medium text-white text-lg tracking-[0] leading-5">
            ...
            <div className="grid grid-cols-2 gap-6 w-full">
              <Button
                variant="outline"
                className="h-auto bg-gray-50 border-border shadow-shadow-xs hover:bg-gray-100"
              >
        ...
        <div className="grid grid-cols-2 gap-16">
          <Card className="bg-gray-50 border-border shadow-shadow-sm relative overflow-hidden">
            <img
              ...
              src="/pattern.svg"
            />
            <CardContent className="flex flex-col items-start justify-center gap-12 p-7 relative z-10">
              <div className="flex flex-col items-start justify-center gap-4 w-full">
                <h2 className="flex items-center justify-center w-full [font-family:'Figtree',Helvetica] font-semibold text-[#101828] text-4xl tracking-[-0.40px] leading-[45px]">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                {expertReasons.map((reason, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 p-4 w-full bg-white rounded border border-solid border-[#d4e3f5]"
                  >
                    <div className="rounded flex w-12 h-12 items-center justify-center bg-[#fafcfe] shrink-0">
                      <img className="w-7 h-7" alt="Icon" src={reason.icon} />
                    </div>

                    <p className="flex-1 [font-family:'Figtree',Helvetica] font-medium text-[#0b1c31] text-base tracking-[0] leading-6">
                      {reason.text}
                    </p>
                  </div>
                ))}
            ...
            <CardContent className="flex flex-col items-start justify-center gap-12 p-7 relative z-10">
              ...
              <div className="flex flex-col items-start gap-4 w-full">
                {includedItems.map((item, index) => (
                  ...
                  >
                    <div className="rounded flex w-12 h-12 items-center justify-center bg-[#fafcfe] shrink-0">
                      <span className="[font-family:'Figtree',Helvetica] font-medium text-[#194170] text-xl tracking-[0] leading-6">
                        {item.number}
                      </span>
                    </div>
        ...
        <Card className="bg-[#194170] border-none shadow-shadow-sm">
          <CardContent className="flex items-center gap-6 p-6">
            <div className="flex flex-col items-start gap-2 flex-1">
              <h2 className="flex items-center justify-center w-full [font-family:'Figtree',Helvetica] font-semibold text-white text-3xl tracking-[0] leading-8">
                Smarter Leasing. Bigger Savings. Faster Approvals.
              </h2>

              <p className="w-full flex items-center justify-center [font-family:'Figtree',Helvetica] font-medium text-white text-lg tracking-[0] leading-5">
