      ...
      <div className="gap-6 sm:gap-8 md:gap-10 flex flex-col w-full max-w-[1280px] items-start px-4 sm:px-6">
        <Card className="w-full bg-white rounded border border-solid shadow-shadow-sm">
          <CardContent className="items-center gap-4 sm:gap-5 p-4 sm:p-6 md:p-8 flex flex-col">
            <h2 className="w-full max-w-[976.41px] font-figtree font-semibold text-[#c70036] text-3xl sm:text-4xl md:text-5xl text-center tracking-[-0.80px] leading-tight sm:leading-[48px]">
              Book Your Free 15-Minute Fleet Consultation
            </h2>

            <p className="w-full max-w-[451.11px] text-[#4a5565] text-sm sm:text-base text-center font-figtree font-normal tracking-[0] leading-5 sm:leading-6">
