            ...
            <DynamicContent
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Comprehensive fleet maintenance and servicing solutions.
                </p>
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    Our Maintenance & Servicing details are coming soon. Check back for updates or contact our team for more information.
                  </p>
                </div>
              </div>
                </div>
