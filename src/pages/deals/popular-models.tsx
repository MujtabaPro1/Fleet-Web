...
const PopularModels: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Popular Models</title>
        <meta name="description" content="Explore our most popular fleet vehicle models and special offers." />
      </Head>
      <div className="bg-white px-4 pt-[20px] lg:pt-[60px] mt-5">
        <div className="max-w-7xl px-2 mx-auto flex flex-wrap">
          <div className="w-full mb-10">
            <DynamicContent
              contentKey="popular-models"
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Discover our most sought-after fleet vehicles and find the perfect match for your business needs.
                </p>
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    Our popular models section is coming soon. 
                    Please check back for updates or contact our team for information about our most popular fleet vehicles.
                  </p>
                </div>
              </div>
            </div>
