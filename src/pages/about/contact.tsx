            ...
            <DynamicContent
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Get in touch with our team for inquiries, support, or to discuss your fleet needs.
                </p>
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    Our contact form is coming soon. In the meantime, please reach out to us via email or phone.
                  </p>
                </div>
              </div>
            </div>
