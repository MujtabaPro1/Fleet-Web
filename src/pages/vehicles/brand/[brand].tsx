...
const SearchByBrand: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Search By Popular Brand</title>
...
export async function getStaticPaths() {
  // Define the brands you want to pre-render
  ...
  const brands = ['toyota', 'ford', 'bmw', 'mercedes', 'audi'];
