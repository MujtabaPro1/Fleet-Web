...
const VehicleSearch: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Find Your Fleet Vehicle</title>
        <meta name="description" content="Search for the perfect fleet vehicle for your business needs." />
      </Head>
      <div className="bg-white px-4 pt-[20px] lg:pt-[60px] mt-5">
        <div className="max-w-7xl px-2 mx-auto flex flex-wrap">
          <div className="w-full mb-10">
            <DynamicContent
              contentKey="vehicle-search"
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    Our vehicle search functionality is coming soon. 
                    Please check back for updates or contact our team for assistance finding the right vehicle.
                  </p>
                </div>
              </div>
            </div>
