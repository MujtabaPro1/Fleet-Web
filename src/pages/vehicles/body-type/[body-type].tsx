...
const SearchByBody: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Search By Body Type</title>
        <meta name="description" content="Search for fleet vehicles by body type in Australia." />
      </Head>
      <div className="bg-white px-4 pt-[20px] lg:pt-[60px] mt-5">
        <div className="max-w-7xl px-2 mx-auto flex flex-wrap">
          <div className="w-full mb-10">
            <DynamicContent
              contentKey="search-by-body"
