  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Find answers to frequently asked questions about fleet management and vehicle leasing in Australia." />
      </Head>
            ...
            <DynamicContent
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Find answers to common questions about our services, products, and fleet management solutions.
                </p>
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    We're currently developing our FAQs section. 
                    Please check back soon for answers to common questions or contact our team for immediate assistance.
                  </p>
                </div>
              </div>
            </div>
