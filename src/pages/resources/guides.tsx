...
const Guides: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Guides</title>
        <meta name="description" content="Comprehensive guides and resources for fleet management and vehicle leasing in Australia." />
      </Head>
            ...
            <DynamicContent
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Comprehensive resources to help you navigate fleet management and vehicle leasing decisions.
                </p>
                <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                  ...
                  <p className="text-[18px]">
                    We&apos;re currently developing our guides section. 
                    Please check back soon for helpful resources and information.
                  </p>
                </div>
              </div>
                </div>
