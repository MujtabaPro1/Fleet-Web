...
const Resources: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Resources & Insights</title>
        <meta name="description" content="Access valuable resources and insights about fleet management and vehicle leasing in Australia." />
      </Head>
            ...
            <DynamicContent
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                  Valuable information, guides, and industry insights to help you make informed decisions.
                </p>
