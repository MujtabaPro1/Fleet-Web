...
const InvoiceFinancing: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Invoice Financing</title>
        <meta name="description" content="Invoice financing solutions for businesses in Australia." />
      </Head>
      <div className="bg-white px-4 pt-[20px] lg:pt-[60px] mt-5">
        <div className="max-w-7xl px-2 mx-auto flex flex-wrap">
          <div className="w-full mb-10">
          <DynamicContent
              contentKey="invoice-financing"
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                    ...
                    <p className="text-[18px]">
                      Our Invoice Financing product details are coming soon. 
...
InvoiceFinancing.Layout = "Default";
