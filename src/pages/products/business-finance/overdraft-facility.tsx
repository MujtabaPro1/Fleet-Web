...
const OverdraftFacility: MyPage = () => {
  return (
    <>
      <Head>
        <title>Fleet Leasing Australia | Overdraft Facility</title>
        <meta name="description" content="Business overdraft facility solutions for Australian businesses." />
      </Head>
      <div className="bg-white px-4 pt-[20px] lg:pt-[60px] mt-5">
        <div className="max-w-7xl px-2 mx-auto flex flex-wrap">
          <div className="w-full mb-10">
            <DynamicContent
              contentKey="overdraft-facility"
              ...
              fallbackContent={
                ...
                <div className="flex flex-col items-center justify-center">
                  <p className="font-medium text-center text-[#333] text-[20px] leading-[1.6em] tracking-[-0.03em] max-w-[700px] mb-8">
                    Flexible short-term borrowing solution for your business cash flow needs.
                  </p>
                  <div className="bg-customBlue-100 p-10 rounded-lg w-full max-w-[700px] text-center">
                    ...
                    <p className="text-[18px]">
                      Our Overdraft Facility product details are coming soon. 
...
OverdraftFacility.Layout = "Default";
